  ...
  <div class="card">
    <div class="card-body">
      ...
      <div class="todoapp">
              ...
              >
                <div class="custom-control custom-checkbox">
                  ...
                  <label class="custom-control-label" :for="`${todo.id}`">
                    <s v-if="todo.done === true">{{ todo.todo }}</s>
        ...
        <form class="mt-3" @submit.prevent="saveTodo">
          <div class="row">
            <div class="col">
              <input
            ...
            <div class="col-auto">
              <button
                type="submit"
                class="btn btn-primary width-sm btn-md btn-block"
              >
                Add
              </button>
            </div>
